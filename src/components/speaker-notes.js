...
export const SPEAKER_NOTES = {
  ...
  'slide-roadmap': {
    ...
    script: {
      de: 'Ich habe die Präsentation in fünf Abschnitte gegliedert. Nach einer kurzen Motivation zur Problemstellung behandle ich die theoretischen Grundlagen der Batteriealterung und SOH-Definition. Der Schwerpunkt liegt dann auf der Methodik — zwei Hauptdiagnosesysteme plus ergänzender AUTEL-Snapshot, ein standardisiertes Messprotokoll — und den Ergebnissen, wo ich sechs SOH-Berechnungsmethoden vergleiche. Abschließend ordne ich die Ergebnisse ein und formuliere Empfehlungen.',
      en: 'I have structured the presentation into five sections. After a brief motivation on the problem, I cover the theoretical foundations of battery aging and SOH definition. The focus then lies on methodology — two primary diagnostic systems plus a supplementary AUTEL snapshot, a standardized protocol — and results, where I compare six SOH calculation methods. Finally, I contextualize the findings and formulate recommendations.',
    },
    dataCallouts: [],
    questions: [],
    transition: {
